...
const RelativeAsset: React.FC<AssetProps> = ({ imageSrc, linkTo, hoverImageSrc, extraStyles, extraClasses, onHover, onLeave }) => {
  ...
  return (
    <div
      className={`relative-asset absolute${isHovered ? ' hover-effect' : ''}${extraClasses ? ' ' + extraClasses : ''}`}
