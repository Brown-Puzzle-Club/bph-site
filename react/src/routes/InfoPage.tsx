...
const LocationBox = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`text flex flex-col px-5 ${
          (!justify_left && "text-right") || "text-left"
        }`}
      >
      ...
      <ProgressDocs>
        ...
        <div>
          ...
          <p>
            ...
            be frozen, and physical puzzles will no longer be available to be
            picked up.
          </p>
          <p>
        ...
        <div className="text-right">
          ...
          <p>
            ...
            presence that is not in the running to win, we will also visit you
            frequently to check on your progress and help you along.{" "}
            <b className="bg-[#1d3650]">
              If you are struggling, do not hesitate to reach out
            </b>{" "}
            — the event is meant to be fun, and we want to ensure no hunter is
            left behind! If you want someone on HQ to come and visit you, you
        ...
        <div>
          ...
          <p>
            ...
            <a onClick={() => smoothScroll("on-campus")}>On-Campus</a>{" "}
            Information.
          </p>
        </div>
        <h4>What else?</h4>
        ...
        <div>
          <p>
            ...
            as long as they aren't helping other teams and aren't actively
          ...
          <ul className="pl-3">
            ...
            <li>
              ...
              <a href="https://lens.google/">Google Lens</a> or{" "}
          ...
          <p>
            It won't be necessary to look at the HTML source/JavaScript/CSS on
            any webpages for any puzzle. Infractions or abuse of these elements
            may be grounds for disqualification or removal from the hunt.
          </p>
          <p>
          ...
          <p>
            We reserve the right to change any of these rules. If there's a big
            change, we'll announce it to all teams.
          </p>
          <p>
        ...
        <div>
          <p>
            ...
            summary: in a typical puzzle, you receive some information and have
            to extract an answer out of it, which is almost always an English
            word or phrase. Puzzles can come in many different forms; the only
            real commonality is that you usually receive no direct instructions,
            so it's up to you to figure out how to make sense of the information
            you're given. You can read a longer introduction to puzzlehunts{" "}
            <a href="https://blog.vero.site/post/puzzlehunts">here</a>.
          </p>
          <p>
            If you are new to puzzles and are interested in seeing some
            examples, or if you're looking for some practice, we recommend
        ...
        <div>
          ...
          <p>
            We expect this year's Brown Puzzlehunt to be roughly the same length
            as last year's, but much easier towards the start. Highly
            experienced, somewhat insane online-only teams may finish all online
            components in only a few hours, but we expect and encourage teams
        ...
        <div>
          <p>
            ...
            students, and we hope that we are able to share some of the unique
            history, culture, and student zeitgeist with the puzzle community!
            We're also excited to explore the unique possibility space of
            in-person puzzles.
          </p>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>
              Thoroughly check the work that you've already done. Fixing a small
              mistake or incorrect assumption can greatly help with getting
              unstuck.
            </li>
            <li>
          ...
          <p>
            Remember that after hints are released, you can also use them to get
            a nudge in the right direction. Please use them if you're stuck!
          </p>
        </div>
        <h4>I think there's a mistake in this puzzle!</h4>
        <div>
          <p>
            Please describe the error in a <a href="/contact">contact HQ</a>{" "}
            submission and we'll try to correct it.
          </p>
        </div>
        ...
        <p>
          Visitors and guests are allowed on the Brown University campus without
        ...
        <div className="text-right">
          ...
          <p>
            ...
            events happening all the time. If you're going to be on-site,{" "}
            <b className="bg-[#1d3650]">
        ...
        <div>
          <p>
            ...
            on-campus (participants who are not Brown or RISD students and who
            are under the age of 18). Sorry! However, minors are welcome to
            participate remotely, and teams with minors can still send other
        ...
        <div>
          ...
          <p>
            Some events and puzzles might use locations that require card swipe
            access, which is limited to current undergraduate or graduate
            students (or some faculty). Puzzles which require this will be kept
            to a minimum and, where applicable, clearly marked as such. If you
            know ahead of time that you'll want to participate in these puzzles
            but have no current students on your team,{" "}
            <a href="/contact">contact us</a> before the hunt and we'll find a
        ...
        <div className="pt-2">
          ...
          <div className="transport-box flex items-center">
            ...
            <span>
              Providence lies at the intersection of Interstate 95 and
              Interstate 195. For non-Brown community members and visitors,
              parking is available at the Lot 68 Visitor Parking Garage, also
              known as the Power Street Parking Garage, located at 111 Power
        ...
        <div>
          <p>
            Unfortunately, we are unable to provide accommodation or discounted
            rates for teams who wish to stay on-campus overnight.
          </p>
        </div>
        ...
        <div>
          <p>
            ...
            <b>we will need you to let us know where your HQ is</b>. This is the
            location where you will be spending most of your time solving
            puzzles while you're on-campus. If you are a student team or have
            student members, this might be a dorm common area or an apartment
            near campus, or a noise-tolerant space like the Student Center or
            some floors of the SciLi.
          </p>
          <p>
            If you need a place for your team to work during the hunt, let us
            know during the registration process and we will try to accommodate
            you. Our ability to allocate classrooms like this will be limited,
            so we will prioritize teams which do not have other spaces available
            and who register in advance.
          </p>
        </div>
        <h4>Events</h4>
        <div>
