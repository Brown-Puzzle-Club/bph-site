...
export default function RegisterForm() {
  ...
  useEffect(() => {
    if (form && team && !valuesSet) {
      ...
      const newMembers = members.map((member) => ({ name: member.name, email: member.email }));
    ...
    <div className="register-page min-h-[87vh]">
      <div>
        <Form {...form}>
          ...
          <a href="/todo" className="dark bg-muted/20 hover:bg-muted/80 btn-gradient-1 flex font-semibold items-center text-center justify-center my-5 mx-[33%] transition-colors duration-300 group">
