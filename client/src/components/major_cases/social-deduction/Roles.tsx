  ...
  return (
    <>
      <span className="text-xl">
        <CharacterRoleTooltip char_role={role} scale={false} />
      </span>
      <br></br>
    </>
  );
  ...
  return (
    <div className="roles content p-10">
      <ul className="space-y-5">
        <li>
          <RoleDisplay role={Role.ASSASSIN} /> At night, the Assassin convenes with the Silencer and
          Enchanter under the gleam of the haunting moon.{" "}
          <i>The Assassin acts as the primary villain of the game</i>, assisted by their cronies.
          Assassins are a part of the evil team. Collectively, the evil team can vote on one player
          to kill on every night except the first.
        </li>
        <TextBreak />
        <li>
          <RoleDisplay role={Role.BODYGUARD} /> The Bodyguard was hired by the Hotel Ghoulsby to
          protect the guests from this game of dire stakes.{" "}
          <i>Their job is to choose one guest every night to protect them</i> from the forces that
          be. If the player they are protecting is attacked, they can take a hit on behalf of their
          protected guest and that player will survive. They have a total of two hits before they
          die, which can be taken either directly by the evil team voting to kill them (1 hit) or if
          the player they are protecting is set to die (1 hit). If they are voted out by the{" "}
          <b style={{ color: GOOD_TEXT_COLOR }}>Village</b>, they do not have an extra life and will
          be exiled if the <b style={{ color: GOOD_TEXT_COLOR }}>Village</b> votes for them.
        </li>
        <TextBreak />
        <li>
          ...
          protect themselves, so if they are directly targeted they will die.
        </li>
        <TextBreak />
        <li>
          <RoleDisplay role={Role.ENCHANTER} /> The Enchanter has psychic visions to assist the evil
          team by <i>obscuring the auras of their fellow players</i>. With the power granted them by
          their mystical enchants, they can make one player appear to have an evil aura when viewed
          by the Telepath. Though powerful, this spell only lasts for one night and the true aura
          will resume the next night.
        </li>
        <TextBreak />
        <li>
          <RoleDisplay role={Role.FOOL} /> A depressed cad with some double-crossing tendencies. The
          Fool is neither good nor evil, but they feel trapped as a servant at Hotel Ghoulsby and
          want to leave.{" "}
          <i>
            They win the game if they are exiled by their{" "}
        ...
        <TextBreak />
        <li>
          <RoleDisplay role={Role.GOSSIP} /> Always up for a gab, the Gossip knows the sordid truths
        ...
        <TextBreak />
        <li>
          <RoleDisplay role={Role.HEADHUNTER} /> Why help others when you could make a living
          killing them? The Headhunter is given a target that they must seek to get voted out by the
          town. They win the game and receive their reward if this target is killed by the{" "}
          <b style={{ color: GOOD_TEXT_COLOR }}>Village</b>. Their target is always on the{" "}
          <b style={{ color: GOOD_TEXT_COLOR }}>Village</b> team.{" "}
        </li>
        <TextBreak />
        <li>
          ...
          are on, only that they are on the same or different teams. Two{" "}
          <b style={{ color: SOLO_TEXT_COLOR }}>Solo</b> players will appear to be on different
          teams.
        </li>
        <TextBreak />
        <li>
        ...
        <li>
          <span className="text-xl">
            <CharacterRoleTooltip char_role={Role.RESURRECTED} scale={false} /> (
            <b style={{ color: GOOD_TEXT_COLOR }}>Village</b> or{" "}
        ...
        <li>
          ...
          obscure their ability.{" "}
        </li>
        <TextBreak />
        <li>
          <RoleDisplay role={Role.VILLAGER} /> A good member of the{" "}
          <b style={{ color: GOOD_TEXT_COLOR }}>Village</b>. <i>No special abilities.</i>{" "}
        </li>
        <TextBreak />
        <li>
