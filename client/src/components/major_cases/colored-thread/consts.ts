...
export const THREAD_SELECTED_DOCTOR_GLOW = "drop-shadow-[0_15px_15px_rgba(0,0,255,0.6)]";
export const THREAD_SELECTED_GOREY_GLOW = "drop-shadow-[0_15px_15px_rgba(255,0,0,0.6)]";
export const THREAD_SELECTED_PUSS_GLOW = "drop-shadow-[0_15px_15px_rgba(255,180,0,0.6)]";
