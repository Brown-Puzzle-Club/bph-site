...
import tax2 from "@/assets/minor_cases/financial_crimes/1040.png";
import tax1 from "@/assets/minor_cases/financial_crimes/w9.png";
...
import whales2 from "@/assets/minor_cases/whales/whales-teaser2.png";
...
export const WhalesArt = () => {
  return (
    <div>
      <img
        className="absolute shadow-lg aspect-square object-cover w-[8vw]"
        style={{ left: "10%", top: "16%", rotate: "345deg" }}
        src={whales2}
      />
      <img
        className="absolute shadow-lg aspect-square object-cover w-[10vw]"
      ...
      <img
        className="absolute shadow-lg aspect-square object-cover w-[15vw]"
        style={{ left: "22%", top: "44%", rotate: "23deg" }}
        src={whales1}
      />
      <img
        className="absolute object-cover w-[15vw]"
        style={{ left: "20%", top: "-12%", rotate: "3deg" }}
        src={anchor}
      />
      <img
...
export const PennyArt = () => {
  return (
    <div>
      ...
      />
      <img
        className="absolute object-cover w-[27vw]"
        style={{ left: "6%", top: "47%", rotate: "0deg" }}
        src={rtpaper1}
      />
      <img
        className="absolute object-cover w-[27vw]"
        style={{ left: "6%", top: "48%", rotate: "0deg" }}
        src={wreath}
      />
    </div>
  );
...
export const NYTCaseArt = () => {
  return (
    <div>
      ...
      />
      <img
        className="absolute object-cover w-[10vw]"
        style={{ left: "17%", top: "37%", rotate: "348deg" }}
        src={tape}
      />
      <img
...
export const MicroinfluencerCaseArt = () => {
  return (
    <div>
      ...
      />
      <img
        className="absolute object-cover w-[14vw]"
        style={{ left: "25%", top: "73%", rotate: "354deg" }}
        src={datasticker1}
      />
    </div>
  );
};
export const LockboxArt = () => {
  return (
    <div>
      <img
        className="absolute shadow-lg object-cover w-[22vw]"
        style={{ left: "8%", top: "10%", rotate: "0deg" }}
        src={lockbox}
      />
      <img
        className="absolute object-cover w-[18vw]"
        style={{ left: "26%", top: "2%", rotate: "10deg" }}
        src={tape}
      />
      <img
        className="absolute object-cover w-[18vw]"
        style={{ left: "-1%", top: "23%", rotate: "10deg" }}
        src={tape}
      />
      <img
        className="absolute object-cover w-[14vw]"
        style={{ left: "12%", top: "73%", rotate: "354deg" }}
        src={datasticker1}
      />
      <img
        className="absolute object-cover w-[14vw]"
        style={{ left: "25%", top: "36%", rotate: "354deg" }}
        src={datasticker2}
      />
    </div>
  );
};
export const FinancialCrimesArt = () => {
  return (
    <div>
      <img
