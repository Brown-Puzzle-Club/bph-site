  ...
  .refine(
    (data) => {
      ...
      if (data.in_person) {
        return (
          (data.phone_number ?? "") !== "" &&
          validator.isMobilePhone(data.phone_number ?? "", "en-US")
        );
      }
      return true;
    },
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 text-white dark">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This is the private username your team will use when logging in. It should be
                      short and not contain special characters.
                    </FormDescription>
                  ...
                  <FormItem>
                    <div className="space-y-4">
                      ...
                      {memberCount < MEMBER_COUNT_MAX ? (
                        <Button
                          className="bg-transparent font-bold text-white hover:text-black"
                          type="button"
                          onClick={() => addMemberCount()}
                        >
                          +
                        </Button>
                      ) : null}
            ...
            <section className="on-campus space-y-4 border-b-4 border-slate-800 pb-8">
              ...
              <h4 className="text-center text-slate-400 text-sm">
                <b>Brown Puzzlehunt offers equal accessibility to remote and in-person solvers</b>,
                but will run separate leaderboards due to slight event differences:
              </h4>
              <h4 className="text-center text-slate-400 text-sm">
                <b>In person teams</b> will have access to events, physical puzzles, in-person
                interactions, and runarounds. <b>Remote teams</b> will have alternative content for
                physical puzzles and will be exempt from events and runarounds.
              </h4>
              <h4 className="text-center text-slate-400 text-sm">
                <b>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                Required for all on-site teams. This will be our primary
                                communication method with you.
                              </FormDescription>
                              <FormMessage className="text-right" />
                            </FormItem>
                          )}
                                ...
                                <FormField
                                  ...
                                  render={({ field }) => (
                                    <FormItem>
                                      ...
                                      <FormDescription>
                                        (e.g: Hegeman Common Room, Barus and Holley Room ###, Zoom,
                                        Discord, etc.)
                                      </FormDescription>
                                      <FormMessage className="text-right" />
                                    </FormItem>
