...
WORDS_ROUND1 = [
    "STITCH", "CARPET", "BEAST", "OX",
    "POOP", "DISCO", "NEMO", "NAUGHTY",
    "SNAIL", "NOTE", "CAMEL", "TREBLE",
    "CHAIN", "DUMB", "HOOK", "CRAP"
]
CONNECTIONS_ROUND1 = {
...
WORDS_ROUND2 = [
    "SITCH", "CARET", "BEAT", "O",
    "POP", "DISC", "EMO", "NAUGHT",
    "NAIL", "NOT", "CAME", "TREBLE N/A",
    "CHIN", "DUB", "HOOK N/A", "RAP"
...
WORDS_ROUND3 = [
    "ITCH", "CARE", "BET", "",
    "OP", "DIS", "MO", "AUGHT",
    "NIL", "NO", "CAM", "TREBLE N/A",
    "CHI", "DUB N/A", "HOOK N/A", "RA"
]
CONNECTIONS_ROUND3 = {
...
WORDS_ROUND4 = [
    "ITCH N/A", "ARE", "BE", "N/A",
    "OP N/A", "IS", "MO N/A", "AUGHT N/A",
    "NIL N/A", "NO N/A", "AM", "TREBLE N/A",
    "HI", "DUB N/A", "HOOK N/A", "A"
]
CONNECTIONS_ROUND4 = {
    "Forms of 'To Be'" : ["ARE", "BE", "IS", "AM"]
}
